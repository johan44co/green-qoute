    ...
    <div className="max-w-2xl mx-auto">
      ...
      <Form errors={errors} onFormSubmit={handleSubmit}>
        ...
        <Field.Root name="address1">
          ...
          <Input type="text" placeholder="Hauptstraße 123" />
          <Field.Error />
        </Field.Root>

        <Field.Root name="address2">
          <Field.Label>Address Line 2 (Optional)</Field.Label>
          <Input type="text" placeholder="Wohnung 4B" />
          <Field.Error />
        </Field.Root>
        ...
        <Field.Root name="country">
          ...
          <ComboboxRoot items={countryList}>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Field.Root name="monthlyConsumptionKwh">
            ...
            <Input type="number" placeholder="400" step="1" min="0" />
            <Field.Description>
          ...
          <Field.Root name="systemSizeKw">
            ...
            <Input type="number" placeholder="5" step="0.1" min="0" />
            <Field.Description>Desired solar system capacity</Field.Description>
            <Field.Error />
          </Field.Root>
        </div>
        ...
        <Field.Root name="downPayment">
          ...
          <Input type="number" placeholder="0" step="100" min="0" />
          <Field.Description>
